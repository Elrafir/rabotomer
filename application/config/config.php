...
|
*/
$config['base_url'] = 'http://192.168.100.2:7880/';
...
|
*/
$config['encryption_key'] = hex2bin('9f6e3a1b8c2d7f4e0a5b9c8d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2b1c0e9f8a');
...
/*
|--------------------------------------------------------------------------
| Cron Secret Token (секретный токен для автоматических задач)
|--------------------------------------------------------------------------
|
| Используется контроллером Cron для авторизации HTTP-запросов.
| Пример вызова из crontab (ежедневно в 03:00):
|
|   0 3 * * * curl -s "http://192.168.100.2:7880/index.php/cron/backup_db/ТОКЕН" > /dev/null 2>&1
|
*/
$config['cron_secret_token'] = 'bkp_7x9Qm2Wf4rT8sKpL';
