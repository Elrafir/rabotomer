...
<!-- Модальное окно редактирования пакета с z-index фиксом -->
<div id="editPackageModal" onclick="$('#editPackageModal').addClass('hidden')" class="hidden fixed inset-0 z-[99999] bg-black bg-opacity-50 flex items-center justify-center p-4">
