...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden sticky top-4">
    ...
    <nav class="flex flex-col p-2 gap-1">
        ...
        <a href="<?= site_url('reports/time_slice') ?>" title="Временной срез" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors <?= $time_classes; ?>">
            <span class="flex-shrink-0 text-lg">⏰</span>
            <span class="sidebar-label">Временной срез</span>
        </a>
        ...
        <a href="<?= site_url('reports/project_slice') ?>" title="Проектный срез" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors <?= $project_classes; ?>">
            <span class="flex-shrink-0 text-lg">📂</span>
            <span class="sidebar-label">Проектный срез</span>
        </a>
        ...
        <a href="<?= site_url('calculations') ?>" title="<?= lang('nav_calculations') ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors <?= $calc_classes; ?>">
            <span class="flex-shrink-0 text-lg">🧮</span>
            <span class="sidebar-label"><?= lang('nav_calculations'); ?></span>
        </a>
        ...
        <a href="<?= site_url('history') ?>" title="<?= lang('nav_history') ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-colors <?= $history_classes; ?>">
            <span class="flex-shrink-0 text-lg">📓</span>
